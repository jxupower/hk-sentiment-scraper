...
def register_stock_research_callbacks(app, db_path: str):
    ...
    @app.callback(
        ...
        # --- extended coverage: layout-hardcoded strings ---
        Output("sr-label-current-price", "children"),
        Output("sr-label-mkt-cap", "children"),
        Output("sr-composite-title", "children"),
        Output("sr-composite-stat-count-label", "children"),
        Output("sr-composite-stat-mcap-label", "children"),
        Output("sr-composite-stat-pe-label", "children"),
        Output("sr-composite-stat-pb-label", "children"),
        Output("sr-composite-stat-roe-label", "children"),
        Output("sr-composite-stat-div-label", "children"),
        Output("sr-constituents-title", "children"),
        Output("sr-constituents-subtitle", "children"),
        Output("sr-composite-table", "columns"),
        Output("sr-business-summary-title", "children"),
        Output("sr-swot-strengths-label", "children"),
        Output("sr-swot-weaknesses-label", "children"),
        Output("sr-swot-opportunities-label", "children"),
        Output("sr-swot-threats-label", "children"),
        Output("sr-articles-title", "children"),
        Output("sr-cagr-title", "children"),
        Output("sr-peer-title", "children"),
        Output("sr-forensic-title", "children"),
        Output("sr-fs-load-btn", "children"),
        Output("sr-fs-tab-income", "label"),
        Output("sr-fs-tab-balance", "label"),
        Output("sr-fs-tab-cashflow", "label"),
        Output("sr-fs-tab-earnings", "label"),
        Output("sr-fs-income-advanced-summary", "children"),
        Output("sr-fs-balance-advanced-summary", "children"),
        Output("sr-fs-cashflow-advanced-summary", "children"),
        Output("sr-label-period", "children"),
        Output("sr-label-period-hint", "children"),
        Output("sr-price-history-title", "children"),
        Output("sr-price-chart-style", "options"),
        Output("sr-strategy-notes-title", "children"),
        Output("sr-strategy-notes", "placeholder"),
        Output("sr-strategy-data-note", "children"),
        Output("sr-relval-title", "children"),
        Output("sr-dcf-title", "children"),
        Output("sr-dcf-label-g15", "children"),
        Output("sr-dcf-label-g610", "children"),
        Output("sr-dcf-label-tg", "children"),
        Output("sr-dcf-label-wacc", "children"),
        Output("sr-dcf-walkthrough-title", "children"),
        Output("sr-valuation-notes-title", "children"),
        Output("sr-valuation-notes", "placeholder"),
        Output("sr-thesis-title", "children"),
        Output("sr-thesis", "placeholder"),
        Output("sr-devil-title", "children"),
        Output("sr-factor-breakdown-drawer", "title"),
        Output("sr-swot-strengths", "placeholder"),
        Output("sr-swot-weaknesses", "placeholder"),
        Output("sr-swot-opportunities", "placeholder"),
        Output("sr-swot-threats", "placeholder"),
    ...
    def i18n_research(lang, market):
        ...
        # Composite constituents-table columns
        composite_cols = [
            {"name": I("research.constituent.ticker", lang),   "id": "ticker"},
            {"name": I("research.constituent.name", lang),     "id": "name"},
            {"name": I("research.constituent.sector", lang),   "id": "sector"},
            {"name": I("research.constituent.mcap_b", lang),   "id": "market_cap_b",
             "type": "numeric"},
            {"name": I("research.constituent.weight", lang),   "id": "weight",
             "type": "numeric"},
            {"name": I("research.constituent.pe", lang),       "id": "trailing_pe",
             "type": "numeric"},
            {"name": I("research.constituent.pb", lang),       "id": "price_to_book",
             "type": "numeric"},
            {"name": I("research.constituent.roe", lang),      "id": "roe_pct",
             "type": "numeric"},
            {"name": I("research.constituent.growth", lang),   "id": "growth_pct",
             "type": "numeric"},
            {"name": I("research.constituent.yield", lang),    "id": "div_yield",
             "type": "numeric"},
            {"name": I("research.constituent.complete", lang), "id": "completeness_pct",
             "type": "numeric"},
        ]
        # Line/Candle chart-style toggle options (translated labels, same values)
        price_style_options = [
            {"label": I("research.chart_style.line", lang),   "value": "line"},
            {"label": I("research.chart_style.candle", lang), "value": "candle"},
        ]
        return (
            ...
            # Extended coverage
            I("research.label.current_price", lang),
            I("research.label.mkt_cap", lang),
            I("research.label.subsector_composite", lang),
            I("research.composite.constituents", lang),
            I("research.composite.total_mcap", lang),
            I("research.composite.median_pe", lang),
            I("research.composite.median_pb", lang),
            I("research.composite.median_roe", lang),
            I("research.composite.median_div", lang),
            I("research.constituents_hdr", lang),
            I("research.constituents_hdr.sub", lang),
            composite_cols,
            I("research.business.summary", lang),
            I("research.swot.strengths", lang),
            I("research.swot.weaknesses", lang),
            I("research.swot.opportunities", lang),
            I("research.swot.threats", lang),
            I("research.articles_title", lang),
            I("research.cagr_title", lang),
            I("research.peer_title", lang),
            I("research.forensic_title", lang),
            I("research.btn.load_financial_statements", lang),
            I("research.fs.income", lang),
            I("research.fs.balance", lang),
            I("research.fs.cashflow", lang),
            I("research.fs.earnings", lang),
            I("research.stmt.show_advanced", lang),
            I("research.stmt.show_advanced", lang),
            I("research.stmt.show_advanced", lang),
            I("research.label.period", lang),
            I("research.period.hint", lang),
            I("research.label.price_chart", lang),
            price_style_options,
            I("research.header.strategy_notes", lang),
            I("research.notes.strategy_ph", lang),
            I("research.strategy.data_note", lang),
            I("research.section.relval_full", lang),
            I("research.section.dcf_full", lang),
            I("research.dcf.g15", lang),
            I("research.dcf.g610", lang),
            I("research.dcf.tg", lang),
            I("research.dcf.wacc", lang),
            I("research.dcf.walkthrough", lang),
            I("research.header.valuation_notes", lang),
            I("research.notes.valuation_ph", lang),
            I("research.label.thesis", lang),
            I("research.notes.thesis_ph", lang),
            I("research.label.devils_advocate", lang),
            I("research.factor.drawer_title", lang),
            I("research.notes.swot_ph", lang),
            I("research.notes.swot_ph", lang),
            I("research.notes.swot_ph", lang),
            I("research.notes.swot_ph", lang),
        )
    ...
    def render_report(_clicks, nav_data, convention, lang,
                        state_ticker, state_options):
    ...
    def load_financial_statements(_clicks, convention, lang, ticker):
        if not ticker:
